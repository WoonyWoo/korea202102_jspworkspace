 ...
 * Generated at: 2021-06-29 14:57:49 UTC
...
NewsDAO newsDAO = new MybatisNewsDAO(); 
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	News news = newsDAO.select(news_id);
      ...
      out.write("				<input type=\"text\" value={obj.cdate} style={{width:\"10%\"}}/>\r\n");
      out.write("			</div>\r\n");
      out.write("			);\r\n");
      out.write("		}			\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//댓글등록(새로고침 없이!! 즉 비동기로 처리)\r\n");
      ...
      out.write("		type:\"post\", \r\n");
      out.write("		data:formdata, //폼을 전송할 수 있는 문자열로 변환\r\n");
      out.write("		success:function(result, status, xhr){\r\n");
      out.write("			if(result==1){\r\n");
      out.write("				//댓글 	목록을 가져와서 동적으로 늘려나가기\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//방법2) 출력 대상이 되는 태그를 객체로 처리하는 방법\r\n");
      out.write("function printCommentsList2(json){\r\n");
      out.write("	$(\"#commentsArea\").html(\"\");//기존의 데이터 삭제\r\n");
      out.write("	\r\n");
      out.write("	for(var i=0;i<json.commentsList.length;i++){\r\n");
      ...
      out.write("	<!-- <div>\r\n");
      out.write("		<input type=\"text\" value=\"댓글 메시지...\" style=\"width:60%\" readonly>\r\n");
      out.write("		<input type=\"text\" value=\"작성자...\"  style=\"width:20%\" readonly>\r\n");
      out.write("		<input type=\"text\" value=\"등록일\"  style=\"width:10%\" readonly>\r\n");
      out.write("	</div> -->\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
